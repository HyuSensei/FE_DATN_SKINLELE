...
const CustomerItemByDoctor = ({ customer, conversation }) => {
    ...
    return (
        <div
            className={`flex justify-between hover:bg-gray-50 hover:rounded-md cursor-pointer ${conversation && !isOwnerRead ? "bg-gray-100" : ""
                } px-4 py-6`}
            ...
            <div className="flex items-center space-x-3 w-full">
                ...
                <div className="flex-1">
                    ...
                    {conversation && conversation.lastMessage && (
                        <div className="py-1 ">
                            <p
                                className={`text-sm line-clamp-1 truncate ${isOwnerRead ? "text-gray-500 " : "text-gray-600 font-medium"
                                    }`}
                            >
                                {isOwner ? "Bạn:" : ""}{" "}
