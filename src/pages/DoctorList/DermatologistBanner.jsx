...
const DermatologistBanner = () => {
  return (
    <div className="relative bg-gradient-to-r from-blue-600 to-blue-400 overflow-hidden rounded-t-md">
      {/* Decorative circles */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white">
            ...
            >
              Chăm sóc sức khỏe làn da của bạn với đội ngũ bác sĩ giàu kinh nghiệm và được đào tạo chuyên sâu
            </motion.p>

            {/* Stats */}
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 mb-16">
              {[
                { icon: FaUserMd, label: "Bác sĩ chuyên khoa", value: "50+" },
                { icon: FaStar, label: "Đánh giá tích cực", value: "4.8/5" },
                { icon: FaClinicMedical, label: "Phòng khám", value: "20+" },
                { icon: FaCertificate, label: "Năm kinh nghiệm", value: "15+" }
              ].map((stat, index) => (
                <motion.div
                  key={index}
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-medium text-gray-600">Đang hoạt động</span>
              </div>
